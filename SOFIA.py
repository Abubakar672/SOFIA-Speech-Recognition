...
def speak(audio_string):
    ...
    r = random.randint(1,20000000000)
...
def respond(voice_data):
    # 1: greeting
    if there_exists(['sophia','sofia','hey']):
    ...
    if there_exists(["what is your name","what's your name","tell me your name","Who are you"]):
        if person_obj.name:
            ...
            speak("my name is SOFIA and i am designed by ABUBAKAR. what's your name?")

    if there_exists(["ABUBAKAR"]):
